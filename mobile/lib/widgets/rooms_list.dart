...
import 'package:foodybite_app/shared/data.dart';
import 'package:foodybite_app/widgets/room_card/room_card.dart';
    ...
    return AnimatedContainer(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return RoomCard(page: index, room: rooms[index], isActive: isActive);
        },
      ),
    );
  }
