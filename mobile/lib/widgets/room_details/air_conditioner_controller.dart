...
import 'package:foodybite_app/widgets/gradient_box.dart';
              ...
              child: Row(
                ...
                children: <Widget>[
                  Transform.translate(
                    ...
                    child: Image.asset('assets/images/ac_white_icon.png',
                    ...
                    children: <Widget>[
                      StreamBuilder(
                        ...
                        builder:
                          ...
                          var temp = (snapshot.data != null)
                              ? snapshot.data.temprature
                              : _store.temp;
                          return Material(
                            color: Colors.transparent,
                            child: Text(
                      ...
                      child: StatefulBuilder(
                        builder: (BuildContext context, StateSetter setState) {
                          return Slider(
                              ...
                              max: 40.0,
                              label:
                                  '${(_value / 100 * 100).toInt()}${String.fromCharCode(html.$deg)}c',
                              onChanged: (value) {
                                setState(() {
                                  _value = value;
                                });
